  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-6 shadow-lg">
        <h1 className="text-3xl font-bold mb-2">Computer Interfacing & Microprocessors</h1>
        <p className="text-indigo-100">Complete Exam Study Guide - Learn Every Concept</p>
        <div className="mt-4 bg-white/20 backdrop-blur p-3 rounded-lg">
          <p className="text-sm">📚 This guide covers all topics from your course material</p>
          <p className="text-sm">💡 Click on any section to expand and learn</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {sections.map((section) => (
              <button
                ...
                className={`${section.color} hover:opacity-90 text-white p-6 rounded-xl shadow-lg transition-all transform hover:scale-105`}
              >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
              ...
              <div className="lg:col-span-3 bg-white rounded-xl shadow-lg p-6">
                <h2 className="text-2xl font-bold mb-6 flex items-center gap-3">
                  <div className={`${currentSection.color} w-10 h-10 rounded-full flex items-center justify-center text-white`}>
                    {currentSection.icon}
                  </div>
      ...
      <div className="bg-gray-800 text-white p-6 mt-12">
        <div className="max-w-7xl mx-auto text-center">
          <p className="font-bold mb-2">Good Luck on Your Exam! 🎓</p>
          <p className="text-sm text-gray-300">Study each section carefully and make sure you understand the concepts</p>
        </div>
      </div>
    </div>
  );
